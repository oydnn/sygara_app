        ...
        children: [
          ...
          Container(
            ...
            child: SingleChildScrollView(
              ...
              child: Row(
                children: [
                  ProductWidget(imgUrl: 'assets/img-pisang.png', 
                  nama: 'Pisang Cavendish', 
                  harga: 'Rp. 15.000/kg'
                  ),
                  SizedBox(width: 20,),
                  ProductWidget(imgUrl: 'assets/img-bayam.png', 
                  nama: 'Bayam', 
                  harga: 'Rp. 15.000/kg'
                  ),
                  SizedBox(width: 20,),
                  ProductWidget(imgUrl: 'assets/img-tomat.png', 
                  nama: 'Tomat', 
                  harga: 'Rp. 15.000/kg'
                  )
                ],
          ...
          Container(
            ...
            child: SingleChildScrollView(
              ...
              child: Row(
                children: [
                  ProductWidget(imgUrl: 'assets/img-apel.png', 
                  nama: 'Apel Fuji', 
                  harga: 'Rp. 25.000/kg'
                  ),
                  SizedBox(width: 20,),
                  ProductWidget(imgUrl: 'assets/img-semangka.png', 
                  nama: 'Semangka', 
                  harga: 'Rp. 15.000/kg'
                  ),
                  SizedBox(width: 20,),
                  ProductWidget(imgUrl: 'assets/img-jeruk.png', 
                  nama: 'Jeruk Sunkist', 
                  harga: 'Rp. 10.000/kg'
                  )
                ],
...
Container(
          ...
          Container(
            ...
            child: SingleChildScrollView(
              ...
              child: Row(
                children: [
                  ProductWidget(imgUrl: 'assets/img-wortel.png', 
                  nama: 'Wortel', 
                  harga: 'Rp. 15.000/kg'
                  ),
                  SizedBox(width: 20,),
                  ProductWidget(imgUrl: 'assets/img-brokoli.png', 
                  nama: 'Brokoli', 
                  harga: 'Rp. 25.000/kg'
                  ),
                  SizedBox(width: 20,),
